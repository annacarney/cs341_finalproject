...
public class person {
	...
	public String toString() {
		return "Person [firstName=" + firstName + " " + "lastName=" + lastName + " " + "Phone Number=" + phoneNumber + " " + "Username=" + userName + " " + "Password=" + password + " " + "isAdmin=" + isAdmin + " " + "isStaff=" + isStaff + " " + "isActive=" + isActive + "]";
	}
